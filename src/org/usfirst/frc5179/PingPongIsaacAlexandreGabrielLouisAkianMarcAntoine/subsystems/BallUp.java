 ...
 *
 */
public class BallUp extends Subsystem {
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    SpeedController ballUpMotor = RobotMap.ballUpBallUpMotor;
    ...
    public void initDefaultCommand() {
    	...
    	while (ballUpMotor.get() != OI.WantedSpeed){ // While motor speed is not 0.5
    		ballUpMotor.set(OI.WantedSpeed); // Set to half speed
    	}
